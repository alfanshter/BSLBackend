...
@section('konten')
    <section>
        <div class="breadcrumbs__section breadcrumbs__section-dark bg__style pt-80 pb-130 lazyload"
            data-bg="img/demo_construction/bgteam.png" data-brk-library="component__breadcrumbs_css">
            ...
            <h2 class="font__size-40 line__height-46 font__family-montserrat font__weight-ultralight text-center">
                Our <span class="font__weight-bold">Team</span>
            </h2>
            ...
            <div class="col-xl-3 col-md-6 col-12">
                <article class="brk-team-persone-circle brk-base-box-shadow text-center" data-brk-library="component__team">
                    <div class="brk-team-persone-circle__name-position">
                        <a href="#">
                            <h4 class="font__family-montserrat font__weight-bold font__size-18">Bernard Show</h4>
                        </a>
    ...
    <section class="bg-cover position-relative pt-90 pb-100 lazyload" data-bg="img/demo_construction/bgteams.png">
        ...
        <div class="container">
            <div class="icon__wrapper-main icon__wrapper-triangle active__effect-main text-center"
                ...
                <div class="row no-gutters">
                    <div class="col-lg-4">
                        <div
                            ...
                            <svg xmlns="plant.svg" viewBox="0 0 60 60">
                                <g>
                                    ...
                                    <g clip-path="url(#livicon_magic_fl)">
                                        <g>
                                            <path fill="none" stroke="#F39C12" stroke-width="2"
                                                stroke-linecap="square" stroke-miterlimit="10"
                                                d="M20.15,34.19L29.34,25c0,0,1.41,0,3.54,2.12S35,30.66,35,30.66l-9.19,9.19" />
                                            <path fill="none" stroke="#34495E" stroke-width="2"
                                                stroke-linecap="square" stroke-miterlimit="10"
                            ...
                            <a href="#"
                                class="btn btn-inside-out btn-lg border-radius-30 font__weight-bold btn-min-width-200"
                                data-brk-library="component__button">
