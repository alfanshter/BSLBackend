...
<section>
    <div class="breadcrumbs__section breadcrumbs__section-dark bg__style pt-80 pb-130 lazyload"
        ...
        <h2 class="font__size-40 line__height-46 font__family-montserrat font__weight-ultralight text-center">
            Our <span class="font__weight-bold">Services</span>
        </h2>
...
<section class="container pt-100">
    <div class="row">
        <div class="col-md-6 col-xl-3">
            <figure class="shape-box shape-box_inline" data-brk-library="component__shape_box">
                ...
                <figcaption>
                    <div class="icon">
                        <i class="fas">
                            <img src="{{asset('img/service/prm.svg')}}" alt="">
                        </i>
                    </div>
                    <h4
                    ...
                    <a href="/services-plant-reengenering-&-modification"
                        class="btn btn-inside-out btn-lg border-radius-30 font__weight-bold"
        ...
        <div class="col-md-6 col-xl-3">
            <figure class="shape-box shape-box_inline" data-brk-library="component__shape_box">
                <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                    data-src="{{ asset('img/projects/mro/mro1.jpg') }}" alt="alt" class="lazyload">
                <div class="brk-abs-overlay z-index-0 bg-black opacity-60"></div>
                <figcaption>
                    <div class="icon">
                        <i class="fas">
                            <img src="{{asset('img/service/mro.svg')}}" alt="">
                        </i>
                    </div>
                    <h4
                        class="font__family-montserrat font__weight-bold font__size-18 text-uppercase main-title text-center">
                        Maintenance, Repair & Overhoul </h4>
                    <a href="/services-maintenance-repair-&-overhoul"
                        class="btn btn-inside-out btn-lg border-radius-30 font__weight-bold"
                        data-brk-library="component__button">
                        <span class="before">read more</span><span class="text">Click Me</span><span
                            class="after">read more</span>
        ...
        <div class="col-md-6 col-xl-3">
            <figure class="shape-box shape-box_inline" data-brk-library="component__shape_box">
                <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                    data-src="{{ asset('img/projects/om/om4.jpg') }}" alt="alt" class="lazyload">
                <div class="brk-abs-overlay z-index-0 bg-black opacity-60"></div>
                <figcaption>
                    <div class="icon">
                        <i class="fas">
                            <img src="{{asset('img/service/pom.svg')}}" alt="">
                        </i>
                    </div>
                    <h4
                        class="font__family-montserrat font__weight-bold font__size-18 text-uppercase main-title text-center">
                        Plant Operation & Maintenance </h4>
                    <a href="/services-plant-operation-&-maintenance"
                          class="btn btn-inside-out btn-lg border-radius-30 font__weight-bold"
                        data-brk-library="component__button">
                        <span class="before">read more</span><span class="text">Click Me</span><span
                            class="after">read more</span>
        ...
        <div class="col-md-6 col-xl-3">
            <figure class="shape-box shape-box_inline" data-brk-library="component__shape_box">
                <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                    data-src="{{ asset('img/projects/drr/drr4.jpg') }}" alt="alt" class="lazyload">
                <div class="brk-abs-overlay z-index-0 bg-black opacity-60"></div>
                <figcaption>
                    <div class="icon">
                        <i class="fas">
                            <img src="{{asset('img/service/prr.svg')}}" alt="">
                        </i>
                    </div>
                    <h4
                        class="font__family-montserrat font__weight-bold font__size-18 text-uppercase main-title text-center">
                        Plant Demolition, Relocation & Reactivation </h4>
                    <a href="/services-plant-demolition-relocation-&-reactivation"
                             class="btn btn-inside-out btn-lg border-radius-30 font__weight-bold"
                        data-brk-library="component__button">
                        <span class="before">read more</span><span class="text">Click Me</span><span
                            class="after">read more</span>
        ...
        <div class="col-md-6 col-xl-3">
            <figure class="shape-box shape-box_inline" data-brk-library="component__shape_box">
                <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                    data-src="{{ asset('img/projects/efi/ef2.jpg') }}" alt="alt" class="lazyload">
                <div class="brk-abs-overlay z-index-0 bg-black opacity-60"></div>
                <figcaption>
                    <div class="icon">
                        <i class="fas">
                            <img src="{{asset('img/service/pfi.svg')}}" alt="">
                        </i>
                    </div>
                    <h4
                        class="font__family-montserrat font__weight-bold font__size-18 text-uppercase main-title text-center">
                        Plant Equipment Fabrication & Installation </h4>
                    <a href="/services-plant-equipment-fabrication-&-installation"
                                class="btn btn-inside-out btn-lg border-radius-30 font__weight-bold"
                        data-brk-library="component__button">
                        <span class="before">read more</span><span class="text">Click Me</span><span
                            class="after">read more</span>
        ...
        <div class="col-md-6 col-xl-3">
            <figure class="shape-box shape-box_inline" data-brk-library="component__shape_box">
                <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                    data-src="{{ asset('img/projects/mm/mm1.jpg') }}" alt="alt" class="lazyload">
                <div class="brk-abs-overlay z-index-0 bg-black opacity-60"></div>
                <figcaption>
                    <div class="icon">
                        <i class="fas">
                            <img src="{{asset('img/service/mm.svg')}}" alt="">
                        </i>
                    </div>
                    <h4
                        class="font__family-montserrat font__weight-bold font__size-18 text-uppercase main-title text-center">
                        Machine Maker </h4>
                    <a href="/services-machine-maker"
                                class="btn btn-inside-out btn-lg border-radius-30 font__weight-bold"
                        data-brk-library="component__button">
                        <span class="before">read more</span><span class="text">Click Me</span><span
                            class="after">read more</span>
        ...
        <div class="col-md-6 col-xl-3">
            <figure class="shape-box shape-box_inline" data-brk-library="component__shape_box">
                ...
                <div class="icon">
                        <i class="fas">
                            <img src="{{asset('img/service/wts.svg')}}" alt="">
                        </i>
                    </div>
                    <h4
                        class="font__family-montserrat font__weight-bold font__size-18 text-uppercase main-title text-center">
                        Warehouse & Transportation Services </h4>
                    <a href="/services-warehouse-&-transportation-services"
                        class="btn btn-inside-out btn-lg border-radius-30 font__weight-bold"
                        data-brk-library="component__button">
                        <span class="before">read more</span><span class="text">Click Me</span><span
                            class="after">read more</span>
    ...
    <div class="text-center pt-60 pb-80">
