        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-bordered" id="npm-group">
                        <thead>
                            <div class="row">
                                <div class="col-2">
                                    <div class="dropdown">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#refreshData').on('click', function() {
                    $('#npm-group').DataTable().ajax.reload(); // Reload data tabel
                });
            ...
            function filterByCustomDate() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        const table = $('#npm-group').DataTable();
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.status == 1) {
                            ...
                            $('#npm-group').DataTable().ajax.reload(function() {
            ...
            $('#confirmDelete').click(function() {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        $('#npm-group').DataTable().ajax.reload(); // Reload tabel
                ...
                $.ajax({
                    ...
                    success: (response) => {
                        ...
                        if (response.status === 1) {
                            ...
                            $('#npm-group').DataTable().ajax.reload(null,
